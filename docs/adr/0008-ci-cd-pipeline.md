...
- `ci.yml` and `dependency-review.yml` pin to `ubuntu-24.04` and set
  `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: true` ahead of the June 2026 Node.js
  20 end-of-life for GitHub Actions; the remaining workflows
  (`automerge.yml`, `label.yml`, `merge-gatekeeper.yml`, `release-please.yml`)
  use `ubuntu-latest`
